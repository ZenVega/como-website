...
![Frischluft Medaille]({{ "/assets/img/Frischluft_Medaille.png" | relative_url }}){: .post-img-center }

Mit der Frischluft-Medaille zeichnen wir Räume aus, die über einen Zeitraum von 30 Tagen außerordentlich gut gelüftet sind. Wir vergeben die Frischluft-Medaille, wenn die Momentanwerte im Verlauf eines Tages in weniger als 30 Prozent der Fälle im gelben Bereich (1000 ppm < CO<sub>2</sub> < 1500 ppm) liegen und kein einziger Momentanwert einen hygienisch inakzeptablen Wert innerhalb der 30 Tage (CO<sub>2</sub> > 2000 ppm) überschreitet. 
